...
/*
*这个启动文件针对情况： 删除RedisConfig 启用application.properties
*
 */
@SpringBootApplication(scanBasePackages = "redisCode")
//指定扫描的MyBatis Mapper
@MapperScan(basePackages = "redisCode", annotationClass = Repository.class)
//使用注解驱动缓存机制
@EnableCaching
